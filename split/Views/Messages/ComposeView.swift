...
func paymentFromMsg(_ msg: String) -> Payment {
    ...
    return Payment(to: "*Update to v2.3.0 to view this message*", from: UserDefaults.init(suiteName: "group.com.jtepp.spllit")!.string(forKey: "myName") ?? "noname", reqfrom: rf, time: Int(NSDate().timeIntervalSince1970), memo: msg, type: .groupmessage, by: UserDefaults.standard.string(forKey: "myId") ?? "noId")
}
