            ...
            Button(action: {
                ...
                if amountObj.showBulk {
                    amountObj.bulkPeople.forEach { m in
                        ...
                        })?.name ?? "unknown sender", amount: amountObj.bulkValues[m.id]!, time: Int(NSDate().timeIntervalSince1970), memo: memoText == "" ? "Generated by Bulk split" : memoText, isRequest: false), h: house)
                    }
                } else {
