    ...
    for i in 0..<members.count {
        ...
        for j in 0..<members.count {
            ...
            if (from.balance > 0 && to.balance < 0) {
                ...
                ps.append(Payment(to: from.name, from: to.name, amount: amount, time: Int(NSDate().timeIntervalSince1970), memo: "Generated by Quick settle", isRequest: false, isAn: false, isGM: false, by: UserDefaults.standard.string(forKey: "myId") ?? "Quick settle"))
